...
MAKE SURE YOU ARE LOGED IN YOUR PAYPAL ACCOUNT, AND THAT YOU ARE USING FAKE SANDBOX ACCOUNT

GO TO DEVELOPER PAGE, WHERE YOU CAN CHECK OUT YOUR SANDBOX ACCOUNTS: CUSTOMER OR MERCHANT ACCOUNTS

<https://developer.paypal.com/developer/applications/>

`Sandbox` -> `Accounts` ----> CLICK ON DETAILS TO SEE OR EDIT DETAILES OF AN ACCOUNT

NOW YOU SEE THE DETAILS AND YOU ARE GOING TO USE THOSE DETAILS TO SIGN IN BEFORE PAYING
...
I CAN SEE "sandbox" IN ADRESS BAR SO EVERYTHING IS OK

NOW SIGN IN WITH SOME OF YOURS BUYER SANDBOX ACCOUNT

I PRESSED ON PAY BUTTON AND PAYMENT WEN THROUG

I CN SEE ON ORDER PAGE THAT ACTUALLY EVERYTHING IS UPDATED

WE DON'T SEE PAYPAL BUTTONS ANYMORE, AN LEKE WE SET THROUGH UI I CAN SEE THAT OREDER IS PAYED FOR

SO THAT MAN THAT EVERYTHING ON OUR BACKEND SUCCESSFULLY DID ITS THING, RELATED PymentResult RECORD IS CREATED, AND Order RECORD IS UPDATED  

## WE CAN OPEN PRISMA STUDIO TO SEE IF Order RECORD IS UPDATED, AND IF PaymentResult RECORD IS CREATED

```
yarn prisma:studio
```

## I THINK THAT WE, NOT SO PRACTIACLLY DEFINED SCHEMA FOR Payment RESULT

id AND paymentId SHOUD BE SAME

BETTER TO SAY WE SHOUD HAVE ONLY id AND WE SHOULD EXPLICITELY SET id OF PaymentResult RECARD (NOT TO BE GENERTED BY DEFAULT), WE SHOUD EXPLICITLY SET THAT PAYPAL ORDER ID WHEN CREATING PaymentResult RECORD 

WE CAN'T ALTER SCHEMA AT THIS POINT, BUT NOW YOU KNOW WHAT TO DO IN YOUR NEXT PROJECT