...
## IN NEXT BRANCH, WE ARE MOVING FORWARD TO DEFAINE ADMIN STUFF

WE DIDN'T DEFINE SHOPPING CART FUNCTIONALITY OR UI PART WHERE USERE CAN LOOK INTO ORDERS HE MADE

I WANT TO DEFINE ADMIN FUNCTIONALITY BECAUSE ADMIN SHOUD HAVE POWER TO UPDATE USERS AND DELETE THEM, ALSO TO CREATE AND DELETE AND UPDATE PRODUCTS
